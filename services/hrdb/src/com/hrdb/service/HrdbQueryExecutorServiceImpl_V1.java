...
public class HrdbQueryExecutorServiceImpl_V1 implements HrdbQueryExecutorService_V1 {
    ...
    @Override
    public Page<Object> executeEmployeedatabyID(Pageable pageable, Integer id) {
        Map params = new HashMap(1);

        params.put("id", id);

        return queryExecutor.executeNamedQuery("employeedatabyID", params, Object.class, pageable);
    }
