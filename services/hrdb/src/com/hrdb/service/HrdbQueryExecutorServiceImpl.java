...
public class HrdbQueryExecutorServiceImpl implements HrdbQueryExecutorService {
    ...
    @Transactional(readOnly = true, value = "hrdbTransactionManager")
    @Override
    public Downloadable exportEmployeedatabyID(ExportType exportType, Integer id, Pageable pageable) {
        Map params = new HashMap(1);

        params.put("id", id);

        return queryExecutor.exportNamedQueryData("employeedatabyID", params, exportType, EmployeedatabyIdResponse.class, pageable);
    }
